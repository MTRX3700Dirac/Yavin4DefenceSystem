...
typedef enum{MAX_RANGE, MIN_RANGE, IR_RATE, US_RATE, IR_SAMPLES, US_SAMPLES} RangeSettings;
...
typedef enum{UNDEF, INIT, SRCH, TRCK, MENU, RAW_RANGE_STATE} possible_states;
...
#define INT_SETUP() INTCONbits.GIEH = 1; \
INTCONbits.GIEL = 1; \
PIR1 = 0; \
PIR2 = 0; \
RCONbits.IPEN = 1; \
