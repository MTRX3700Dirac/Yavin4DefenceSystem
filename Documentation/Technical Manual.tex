...
\section{How To Use It:}
\begin{itemize}
	\item Ensure Interrupt.c is included in the project
	\item Include PanTilt.h in the file you want to use the module
	\item Call configureBase() function to set up the module
	\item Call Move() to send the base to a specific direction
	\item Call increment() or incrementFine() to move the base from that direction
