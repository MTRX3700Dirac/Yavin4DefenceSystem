...
>>>>>>> e4fb1f420aea9fd2f8cc6b6e2acfd1195a5b60aa
\end{itemize}
...
\caption[PowerBusDiagram]{Power circuit schematic on veroboard/stripboard}
\label{fig:PowerBusDiagram}
\end{figure}

\subsubsection{Safety Features}
Currently the prototype system does not make use of any type of internal fusing or circuit breaker functionality. Should the system be marketed as a commercial product such features would be essential. The use of a 9V battery is an implicit safety feature due to the low power output. All circuit elements are enclosed and impossible to accidentally come into contact with, especially the large 1mF capacitor located on the power bus, which can produce a painful electric discharge if touched.
...
Much of the code is really just functionality around hardware interfaces, most of which is self explanatory, or accessible through the datasheet. Here we will discuss some of the higher level software modules such as the search, tracking and menus.
...
\subsection{Software Interface}
The software interfaces for each module are described in great detail in the module descriptions document. For the sake of conciseness I will not repeat most of that material here.
