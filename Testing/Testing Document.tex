...
\{\newline
	...
	az = 1000 + dir.azimuth * (long int)1000 / ARC\_RANGE; \newline
	inc = 1000 + dir.inclination * (long int)1000 / ARC\_RANGE; \newline
...
\{ \newline
	...
	ret.azimuth = ((dly.AzimuthDelay - PWM\_HALF\_PERIOD - 1000) * (long int)ARC\_RANGE + 500) / 1000; \newline
	ret.inclination = ((dly.InclinationDelay + LATENCY - 1000) * (long int)ARC\_RANGE + 500) / 1000; \newline
